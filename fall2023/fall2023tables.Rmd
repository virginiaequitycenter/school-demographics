...
The data below provide the details of the 2023-24 demographic composition of all schools in the following school districts in the greater Charlottesville region:
...
reactable(students2024race, filterable = TRUE, minRows = 10,
          columns = list(
              ...
              count_aian = colDef(name = "Am. Indian AK Native",
                                style = list(background = "#e6dbff"), filterable = FALSE),
...
reactable(students2024disadvantaged, filterable = TRUE, minRows = 10, 
          columns = list(
               ...
               count_adv = colDef(name = "Advantaged",
                                style = list(background = "#ffd4c4"), filterable = FALSE),
                count_disadv = colDef(name = "Disadvantaged",
                                style = list(background = "#ffd4c4"), filterable = FALSE),
                perc_adv = colDef(name = "Advantaged",
                                style = list(background = "#ffbba1"),
                               format = colFormat(suffix = "%"), filterable = FALSE),
