...
output: 
  html_document:
    template: school-demographics-template.html
---
```{css, echo=FALSE}
...
columnGroups = list(
    ...
    tags$button(class= "btn btn-default atlas-btn", "Download as CSV", onclick = "Reactable.downloadDataCSV('table_race', 'table_race.csv')")
  )
)
...
reactable(students2024disadvantaged, filterable = TRUE, minRows = 10, 
    ...
    tags$button(class= "btn btn-default atlas-btn", "Download as CSV", onclick = "Reactable.downloadDataCSV('table_econ', 'table_econ.csv')")
  )
)
...
reactable(students2024el, filterable = TRUE, minRows = 10, 
    ...
    tags$button(class= "btn btn-default atlas-btn", "Download as CSV", onclick = "Reactable.downloadDataCSV('table_el','table_el.csv')")
  )
)
```
...
Michele Claibourn, Christopher Hu, Elizabeth Mitchell, Asha Muralidharan, and Nina Schoonover. February 2025. "Local School Demographics." UVA Democracy Initiative Center for the Redress of Inequity through Community-Engaged Scholarship. https://virginiaequitycenter.github.io/cville-equity-atlas/reports/school-composition/.
