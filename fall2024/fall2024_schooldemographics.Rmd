...
columnGroups = list(
    ...
    tags$button(class= "btn btn-default atlas-btn", "Download as CSV", onclick = "Reactable.downloadDataCSV('table2024_2025_race', 'table2024_2025_race.csv')")
  )
)
...
reactable(students2024el, filterable = TRUE, minRows = 10, 
    ...
    tags$button(class= "btn btn-default atlas-btn", "Download as CSV", onclick = "Reactable.downloadDataCSV('table2024_2025_el','table2024_2025_el.csv')")
  )
)
```
