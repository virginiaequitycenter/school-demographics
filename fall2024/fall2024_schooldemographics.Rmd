...
description: "Demographic composition of local schools provided by the Virginia Department of Education."
output: 
  html_document:
...
shape_hs <- st_read(dsn="data/SABS 1516 CVille Region/SABS_1516_VA_CvilleRegion_High.shp") 
shape_ms <- st_read(dsn="data/SABS 1516 CVille Region/SABS_1516_VA_CvilleRegion_Middle.shp")
shape_ps <- st_read(dsn="data/SABS 1516 CVille Region/SABS_1516_VA_CvilleRegion_Primary.shp")
...
load("data/2024tablesrace.Rdata")
load("data/2024tablesdisadvantaged.Rdata")
load("data/2024tablesel.Rdata")
...
columnGroups = list(
    ...
    tags$button(class= "btn btn-default btn-lg", "Download as CSV", onclick = "Reactable.downloadDataCSV('table_race', 'table_race.csv')")
  )
)
...
reactable(students2024disadvantaged, filterable = TRUE, minRows = 10, 
    ...
    tags$button(class= "btn btn-default btn-lg", "Download as CSV", onclick = "Reactable.downloadDataCSV('table_econ', 'table_econ.csv')")
  )
)
...
reactable(students2024el, filterable = TRUE, minRows = 10, 
    ...
    tags$button(class= "btn btn-default btn-lg", "Download as CSV", onclick = "Reactable.downloadDataCSV('table_el','table_el.csv')")
  )
)
```
...
Michele Claibourn, Christopher Hu, Elizabeth Mitchell, Asha Muralidharan, and Nina Schoonover. February 2025. "Local School Demographics." UVA Democracy Initiative Center for the Redress of Inequity through Community-Engaged Scholarship. https://virginiaequitycenter.github.io/school-demographics/fall2024/fall2024_schooldemographics.html
