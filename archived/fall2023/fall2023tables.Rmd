...
```
## Demographic Map {.tabset}

The map below provides the details of the demographic composition of all schools in the school districts in the greater Charlottesville region:
...
>>>>>>> eccfd2470b6754f551157a99aec7251b0598ea3a
...
<<<<<<< HEAD
                                style = list(background = "#D8F2E4"), filterable = FALSE),
...
<<<<<<< HEAD
                                style = list(background = "#FAE2B8"), filterable = FALSE),
                count_disadv = colDef(name = "Disadvantaged",
                                style = list(background = "#FAE2B8"), filterable = FALSE),
                perc_adv = colDef(name = "Advantaged",
                                style = list(background = "#FAE2B8"),
                               format = colFormat(suffix = "%"), filterable = FALSE),
