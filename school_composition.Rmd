...
reactable(students2022,
          columns = list(
            ...
            students = colDef(name = "Students",
                                style = list(background = "#F4E3D3FF")),
            count_aian = colDef(name = "American Indian",
            ...
            count_white = colDef(name = "White",
                                style = list(background = "#ADB7C0FF")),
            count_nhpi = colDef(name = "Native Hawaiian",
                                style = list(background = "#ADB7C0FF")),
            perc_aian = colDef(name = "American Indian",
                               style = list(background = "#ADB7C0FF"),
            ...
            perc_white = colDef(name = "White",
                                style = list(background = "#ADB7C0FF"),
                               format = colFormat(suffix = "%")),
            perc_nhpi = colDef(name = "Native Hawaiian",
                                style = list(background = "#ADB7C0FF"),
                               format = colFormat(suffix = "%")),
          ...
          showSortable = TRUE, defaultPageSize = 12, compact = TRUE)
```
...
reactable(students2020,
          ...
          showSortable = TRUE, defaultPageSize = 13, compact = TRUE)
```
